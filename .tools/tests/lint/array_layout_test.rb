...
class ArrayLayoutTest < CheckTestCase
  def test_layout_handles_strings_comments_and_nested_types
    assert_empty findings(fixture(:sample), 'project_layout')
    refute_empty findings(fixture(:sample2), 'project_layout')
  end
