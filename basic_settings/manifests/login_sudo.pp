...
#
# This defined type installs sudo when needed and writes a single sudoers snippet under `/etc/sudoers.d`. It is used by
# service modules that need controlled command delegation while keeping sudoers files root-owned and mode `0440`.
#
