...
#
# This private helper writes or removes the Nginx mainline package source and signing key. It is called by
# `basic_settings` after OS support has been calculated.
#
