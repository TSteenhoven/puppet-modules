define nginx::server (
  ...
  String              $ip                         = undef,
  String              $ipv6                       = undef,
  String              $keepalive_request_file     = undef,
  ...
  String              $redirect_certificate       = undef,
  String              $redirect_certificate_ke    = undef,
  String              $redirect_from              = undef,
  String              $redirect_http_port         = undef,
  String              $redirect_https_port        = undef,
  String              $redirect_ip                = undef,
  String              $redirect_ipv6              = undef,
  Array               $redirect_ssl_ciphers       = undef,
  String              $redirect_ssl_protocols     = undef,
  Optional[Boolean]   $restart_service            = true,
  Optional[Boolean]   $reuseport                  = false, # Global settings
  String              $server_name                = undef,
  Integer             $ssl_buffer_size            = undef,
  String              $ssl_certificate            = undef,
  String              $ssl_certificate_key        = undef,
  Array               $ssl_ciphers                = [
  ...
  String              $ssl_protocols              = undef,
  String              $ssl_session_cache          = undef,
  String              $ssl_session_timeout        = undef,
